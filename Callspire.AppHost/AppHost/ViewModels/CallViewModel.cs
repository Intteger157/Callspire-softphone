...
namespace Softphone.AppHost.ViewModels
{
    ...
    public sealed class CallViewModel : ObservableObject, IDisposable
    {
        ...
        /// <summary>The request this call was opened with (slot, originate flag) — for hosts that project state remotely.</summary>
        public CallWindowRequest Request => _request;
