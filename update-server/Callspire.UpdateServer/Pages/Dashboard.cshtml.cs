...
public class DashboardModel : PageModel
{
    ...
    public async Task OnGetAsync()
    {
        ...
        // If someone deletes files manually, update.json and Callspire-setup.exe can disagree.
        // Repair from newest complete archived snapshot before rendering the dashboard.
